                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            ItemUpdateScreen(widget.cartItem, widget.onUpdate),
                      ),
                    );
                  },
                  child: Text(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                if (widget.onUpdate != null) {
                  widget.onUpdate!(updatedItem); // Invoke onUpdate if not null
                }
                Navigator.pop(context);
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.green, // Change to Color object
              ),
              child: const Text(
                'Update Item',
